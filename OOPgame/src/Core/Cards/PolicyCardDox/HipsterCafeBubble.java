...
public class HipsterCafeBubble extends PolicyCard {
    public HipsterCafeBubble(int x, int y, String imagePath) {
        ...
        this.description = "Skill: Play Dev Card with Economy > 0 gain +8 Economy and -3 Coins.";
    }
    ...
    public void onActionCardPlayed(ActionCard playedCard, City city) {
        ...
        if (currentEco > 0) {
            stats.setStats(PoliticsStats.ECONOMY, currentEco + 8);
            ...
            System.out.println("ปั่นกระแสคาเฟ่ฮิปสเตอร์! โครงการ " + playedCard.getName() + " ได้รับ +8 Economy");
