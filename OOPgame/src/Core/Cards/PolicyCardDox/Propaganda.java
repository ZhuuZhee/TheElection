...
public class Propaganda extends PolicyCard {
    ...
    public Propaganda(int x, int y, String imagePath) {
        ...
        this.description = "Skill: All played Dev Cards gain +10 all stats and -1 coin per card.";
    }
    ...
    public PoliticsStats calculateStats(ActionCard playedCard, City city) {
        ...
        if (active && playedCard != lastProcessedCard
            ...
            UINotificationToast.showNotification("[Propaganda] Activate! " + playedCard.getName() + " Gain +10 all stats and -1 coin per card!");
        }
        return stats;
    }
}