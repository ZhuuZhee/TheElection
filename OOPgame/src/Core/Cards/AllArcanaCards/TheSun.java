...
public class TheSun extends ArcanaCard {
    ...
    protected void activateSkill() {
        if (ZhuzheeGame.DEVLOPMENT_CARD_HAND != null) {
            ...
            UINotificationToast.showNotification("The Sun activate! Multiply all your development cards by 20 if they have negative stats change to positive.", 5000, true);
        }
    }
}
