...
//
//    //เอามาใช้คำนวณค่า pixel ของ Map
...
//
//    /**
//     * สร้างรูป hexagon แบบ flat-top
//     * @param x ตำแหน่ง X ของจุดศูนย์กลาง
//     * @param y ตำแหน่ง Y ของจุดศูนย์กลาง
//     * @param radius รัศมีของ hexagon
//     * @return Polygon ของ hexagon
//     */
//    // method ที่เอาไว้สร้างรูป hexagon
...
//
//    /**
//     * สุ่มสร้างแผนที่โดยกำหนดค่าแต่ละเซลล์เป็น 0 หรือ 1
//     * 0 = พื้นที่ปกติ (สีเขียว), 1 = อุปสรรค (สีน้ำเงิน)
//     */
...
//    }
//
//    // method ที่เอาไว้วาดแผนที่ hexagonal grid พร้อมการ hover และสีตามประเภทพื้นที่
//    @Override
//    protected void paintComponent(Graphics g) {
//        super.paintComponent(g);
//        // set ค่าจาก class Camera
